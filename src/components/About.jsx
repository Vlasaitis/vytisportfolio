                ...
                <div
                  ...
                  <div className={`about-container ${index === aboutSections.length - 1 ? 'mr-0' : 'mr-10'}`}>
                    <div className={`about-header flex flex-1 flex-row sm:pt-16 pt-6 sm:pb-8 pb-4`}>
                      <img className="w-[100px] h-[100px]" src={`${link}${about.logo}`} />
                      <div className={`flex flex-col`}>
                        <h2 className='font-poppins font-semibold text-[30px] text-secondary xs:leading-[76.8px] leading-[66.8px] w-full ml-3'>
                          {about.title}</h2>
